...
public class Cutscenes {
    ...
    public void playCutscene(int cutScene) {
        ...
        switch (cutScene) {
            ...
            case 1 -> print.dramaPrint("\"THAT ONE WAS ON THE MARK{\"}");
            case 2 -> print.dramaPrint("\"CRITICAL HIT{\"}");
            case 3 -> print.dramaPrint("\"NICE SHOT{\"}");
            case 4 -> print.dramaPrint("\"THE BRITISH WILL FEEL THAT ONE{\"}");
            case 5 -> print.dramaPrint("\"GOOD HIT{\"}");
            case 6 -> print.dramaPrint("\"WE'VE LIT THEM UP WELL{\"}");
            case 7 -> print.dramaPrint("\"KING GEORGE'S GONNA FEEL THAT ONE{\"}");
            case 8 -> print.dramaPrint("\"HOWE'S GONNA BE UPSET ABOUT THAT HIT{\"}");
            case 9 -> print.dramaPrint("\"RIGHT THROUGH THOSE REDCOATS{\"}");
            case 10 -> print.dramaPrint("\"WE GOT ONE{\"}");

            // 11 to 20 will be unique miss messages. Some flavor text followed by a one-second delay.
            case 11 -> print.dramaPrint("\"That one hit the fish.\"}");
            case 12 -> print.dramaPrint("\"Off target.\"}");
            case 13 -> print.dramaPrint("\"Not quite on target, Captain.\"}");
            case 14 -> print.dramaPrint("\"Agh, we've missed.\"}");
            case 15 -> print.dramaPrint("\"Our aim's a little off...\"}");
            case 16 -> print.dramaPrint("\"That went right past them.\"}");
            case 17 -> print.dramaPrint("\"Where did they go? Our shell must not have hit!\"}");
            case 18 -> print.dramaPrint("\"Almost got them, but not quite.\"}");
            case 19 -> print.dramaPrint("\"Shoot! We haven't shot them one bit!\"}");
            case 20 -> print.dramaPrint("\"Washington 'll be disappointed, but I'm not, Captain.} We'll get them next shot...\"}");

            // 21-30 will be no ammunition messages.
            case 21 -> print.dramaPrint("\"Tough luck, Captain. We're out of shells this hour.\"}");
            case 22 -> print.dramaPrint("\"None of our ships could resupply, we have no shells.\"}");
            case 23 -> print.dramaPrint("\"Not good...} not good...} we're out of supplies.\"}");
            case 24 -> print.dramaPrint("\"Our ammunition is completely empty. We need to pass this hour by.\"}");
            case 25 -> print.dramaPrint("\"Verdammt! We couldn't resupply for any round shots!\"}");
            case 26 -> print.dramaPrint("\"Our men couldn't even organize a resupply! We cannot fire any of our cannons.\"}");
            case 27 -> print.dramaPrint("\"No good.} The nearby ports are blocked off, we can't resupply, Captain " + captainName + ".\"}");
            case 28 -> print.dramaPrint("\"Agh, our nearby resupply point has been intercepted. We have no ammo at this hour!\"}");
            case 29 -> print.dramaPrint("\"The British have interdicted our supply ships! We can't resupply this hour!.\"}");
            case 30 -> print.dramaPrint("\"Good grief. None of our supply ships could break through the British! We're dry on cannon shot this hour!\"}");
        }
    }
